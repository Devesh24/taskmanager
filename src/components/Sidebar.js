  ...
  return (
    ...
    <span className='d-flex' style={{color: props.mode==='light' ? 'black' : 'white'}}>
      ...
      <span className='sidebar ps-2 pe-2 mt-3'>
        <div className="my-2">
          <Link className="link icon py-3" to="/taskmanager"><i className="fa-regular fa-clipboard fa-xl px-3 py-4" /></Link>
        </div>
        <div className="my-2">
      ...
      <span id="slider" className='pe-5 pt-3' style={{display: props.slide}}>
        <Link className='link' to="/taskmanager"><div className="iconText fs-4 py-2 ps-4 my-2">Tasks</div></Link>
